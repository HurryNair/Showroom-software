...
CREATE TABLE `collection` (
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `manu` FOREIGN KEY (`ID`) REFERENCES `manufacturer` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `location` (
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `vendor_id` FOREIGN KEY (`ID`) REFERENCES `vendor` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `manufacturer` (
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `Image` FOREIGN KEY (`ID`) REFERENCES `image` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `physical_attrib` (
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `dimension` FOREIGN KEY (`ID`) REFERENCES `dimension` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  ...
  `Name` varchar(50) NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `designStyle` FOREIGN KEY (`ID`) REFERENCES `design_style` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fixtureType` FOREIGN KEY (`ID`) REFERENCES `fixture_type` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `manufacturer` FOREIGN KEY (`ID`) REFERENCES `manufacturer` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `physicalAttribute` FOREIGN KEY (`ID`) REFERENCES `physical_attrib` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `technicalAttribute` FOREIGN KEY (`ID`) REFERENCES `technical_attrib` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `warranty` FOREIGN KEY (`ID`) REFERENCES `warranty` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_collection` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  CONSTRAINT `collection` FOREIGN KEY (`ID`) REFERENCES `collection` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `product_images` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  CONSTRAINT `product` FOREIGN KEY (`ID`) REFERENCES `product` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `productImage` FOREIGN KEY (`ID`) REFERENCES `image` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_price` (
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `pricebook` FOREIGN KEY (`ID`) REFERENCES `pricebook` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_stock` (
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `location_id` FOREIGN KEY (`ID`) REFERENCES `location` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `product_id` FOREIGN KEY (`ID`) REFERENCES `product` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `technical_attrib` (
  ...
  `Color_Temperature` varchar(10) NOT NULL,
  `Lumen_Start` varchar(10) NOT NULL,
  `Lumen_End` varchar(10) NOT NULL,
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `holderType` FOREIGN KEY (`ID`) REFERENCES `holder_type` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vendor` (
  ...
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  CONSTRAINT `pri_location` FOREIGN KEY (`ID`) REFERENCES `location` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-04 14:09:34
