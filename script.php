...
$Dia= $_POST['input44'];
$Loc_email= $_POST['input45'];
$Manu_ph= $_POST['input46'];

$query = "INSERT INTO dimension (Width, Height, DEPTH, CUT_OUT, Std_len, Mounting_Pipe_Diameter, Diameter) VALUES ('$Width','$Height','$DEPTH','$Cutout','$Stdlen','$Mounting_Pipe_Diameter', '$Dia');
...
INSERT INTO location (Name, Phone_Number, Address, vendor_id) VALUES ('$Location','$Loc_Ph','$Loc_addr','$Loc_email');
...
INSERT INTO technical_attrib (Wattage,Bulb_Manufacturer,Beam_Angle,Color_Temperature,Lumen_Start,Lumen_End,IP_Rating,Input_Voltage,Output_Voltage,LED_mtr) VALUES ('$Wattage','$LED_Source','$Beam_Angle','$Color_Temperature','$Lumen_Start','$Lumen_End','$IP_Rating','$Input_Voltage','$Output_Voltage','$LED_mtr');
INSERT INTO manufacturer (Name, URL, Email, Phonenumber) VALUES ('$Manufac_name','$Manu_URL','$Manu_email','$Manu_ph');
